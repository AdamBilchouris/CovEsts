...
test_that("truncated_point fails for nonnumeric Xij_mat", {
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, 0.01, matrix(c(1, 'a', 2, 1), ncol=2), test_rhoT1))
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, 0.01, matrix(c(1, 1i, 2, 1), ncol=2), test_rhoT1))
})

test_that("truncated_point fails for nonmatrix Xij_mat", {
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, 'a', 1, test_rhoT1))
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, 1i, c(1, 2), test_rhoT1))
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, 1i, list(a=1, b=2), test_rhoT1))
})
...
test_that("truncated_point fails for any NA element of Xij_mat", {
  expect_error(truncated_point(test_x, test_meanX, 2, 2, 3, NA, matrix(c(1, NA, 2, 1), ncol=2), test_rhoT1))
})
